...
try {
		...
		const ownerNumberr = ["6281389812069@s.whatsapp.net","6285774523785@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
        ...
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/gggghuuuu', "groupName": `${NamaBot}`, "footerText": "*_© IMP-XBOT_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
reply(String(e))
			...
			// Auto Read Group 
var chats = await denz.chats.array.filter(v => v.jid.endsWith('g.us'))
chats.map( async ({ jid }) => {
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, `${uwu}X B O T 右${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`allmenu`,buttonText:{displayText:'MENU📒'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER👤'},type:1},{buttonId:`script`,buttonText:{displayText:'SCRIPT🌹'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'allmenu':
        ptod = "6285774523785@s.whatsapp.net"
        stod = `${sender}`
...
└─────────────────❒
${uwu}`
denz.sendMessage(from, menu, text, { quoted: ftrol, thumbnail: fs.readFileSync('./denz.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/1k8Rd3dnRno`}}})
break
case 'listmenu':
 listMsg = {
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Bitch Boot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://youtube.com/channel/UCtfZkYbSn5kyTcpEhHG7yQw"}}})
	}
    }
    }
    }
